...
class TelefonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create telefone" do
    assert_difference('Telefone.count') do
      post telefones_url, params: { telefone: { ddd: @telefone.ddd, numero: @telefone.numero, preferencial: @telefone.preferencial, tipo: @telefone.tipo } }
    end
  ...
  test "should update telefone" do
    patch telefone_url(@telefone), params: { telefone: { ddd: @telefone.ddd, numero: @telefone.numero, preferencial: @telefone.preferencial, tipo: @telefone.tipo } }
